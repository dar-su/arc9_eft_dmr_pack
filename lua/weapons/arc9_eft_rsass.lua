...
SWEP.Description = ARC9:GetPhrase("eft_weapon_rsass_desc")
...
SWEP.CustomizePos = Vector(22, 46, 4)
...
SWEP.ShootSoundIndoor = path2 .. "rsass_fire_indoor_close.wav"
SWEP.DistantShootSound = path2 .. "rsass_fire_distant1.ogg"
SWEP.DistantShootSoundIndoor = path2 .. "rsass_fire_indoor_distant.wav"

SWEP.ShootSoundSilenced = path2 .. "rsass_close_silenced1.ogg"
SWEP.ShootSoundSilencedIndoor = path2 .. "rsass_indoor_close_silenced1.wav"
SWEP.DistantShootSoundSilenced = path2 .. "rsass_distant_silenced1.ogg"
SWEP.DistantShootSoundSilencedIndoor = path2 .. "rsass_indoor_distant_silenced1.wav"
...
local rst_tac = {
    { s = randspin, t = 0 },
    { s = "arc9_eft_shared/weap_magrelease_button.ogg", t = 0.22 - 4/28 },
    { s = "arc9_eft_shared/weap_magout_plastic.ogg", t = 0.37 - 4/28 },
    { s = randspin, t = 0.72 - 4/28 },
    { s = pouchout, t = 0.89 - 4/28 },
    { s = "arc9_eft_shared/weap_magin_plastic.ogg", t = 1.48 - 4/28 },
    { s = randspin, t = 1.81 - 4/28 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.6- 4/28},
    {hide = 0, t = 1- 4/28}
}
...
local rst_tac10 = {
    ...
    { s = "arc9_eft_shared/weap_magin_plastic.ogg", t = 1.43 - 4/28 },
    { s = randspin, t = 1.77 - 4/28 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.6- 4/28},
    {hide = 0, t = 1- 4/28}
}
...
local rst_tac5 = {
    ...
    { s = "arc9_eft_shared/weap_magout_plastic.ogg", t = 0.37 - 4/28 },
    { s = randspin, t = 0.72 - 4/28 },
    { s = pouchout, t = 0.89+0.1 - 4/28 },
    { s = "arc9_eft_shared/weap_magin_plastic.ogg", t = 1.48+0.2 - 4/28 },
    { s = randspin, t = 1.81+0.2 - 4/28 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.6},
    {hide = 0, t = 1}
}
