...
SWEP.ShootSound = path .. "sr25_fire_outdoor_close.wav"
SWEP.ShootSoundIndoor = path .. "sr25_fire_indoor_close.wav"
SWEP.DistantShootSound = path .. "sr25_fire_outdoor_distant.wav"
SWEP.DistantShootSoundIndoor = path .. "sr25_fire_indoor_distant.wav"

SWEP.ShootSoundSilenced = path .. "sr25_fire_outdoor_silenced_close.wav"
SWEP.ShootSoundSilencedIndoor = path .. "sr25_fire_indoor_silenced_close.wav"
SWEP.DistantShootSoundSilenced = path .. "sr25_fire_outdoor_silenced_distant.wav"
SWEP.DistantShootSoundSilencedIndoor = path .. "sr25_fire_indoor_silenced_distant.wav"
...
local rst_tac = {
    { s = randspin, t = 0.17 - 4/28 },
    { s = "arc9_eft_shared/weap_magrelease_button.ogg", t = 0.08 - 4/28 },
    { s = "arc9_eft_shared/weap_magout_plastic.ogg", t = 0.28 - 4/28 },
    { s = randspin, t = 0.37 - 4/28 },
    { s = pouchout, t = 0.96 - 4/28 },
    { s = "arc9_eft_shared/weap_magin_plastic.ogg", t = 1.49 - 4/28 },
    { s = randspin, t = 2.16 - 4/28 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.67- 4/28},
    {hide = 0, t = 1.05- 4/28}
}
...
local rst_tac10 = {
    ...
    { s = "arc9_eft_shared/weap_magout_plastic.ogg", t = 0.28 - 4/28 },
    { s = randspin, t = 0.37 - 4/28 },
    { s = pouchout, t = 0.96-0.05 - 4/28 },
    { s = "arc9_eft_shared/weap_magin_plastic.ogg", t = 1.49-0.1 - 4/28 },
    { s = randspin, t = 2.16-0.1 - 4/28 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.67- 4/28},
    {hide = 0, t = 1.03- 4/28}
}
...
local rst_tac5 = {
    ...
    { s = "arc9_eft_shared/weap_magout_plastic.ogg", t = 0.28 - 4/28 },
    { s = randspin, t = 0.37 - 4/28 },
    { s = pouchout, t = 0.96+0.1 - 4/28 },
    { s = "arc9_eft_shared/weap_magin_plastic.ogg", t = 1.49 +0.2 - 4/28},
    { s = randspin, t = 2.16+0.2 - 4/28 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.67- 4/28},
    {hide = 0, t = 1.05- 4/28}
}
